...
const PREFERRED = [
  ...
  "Грузія",
  "Україна",
  "Християнський відпочинок на морі",
];
    ...
    <>
      <Container className="pb-2 pt-12 lg:pt-[50px]">
        ...
        <p className="mt-4 max-w-[600px] text-[17px] leading-[1.7] text-text2">
          Оберіть свою духовну подорож за датами та напрямком. Усі наші паломництва ми організовуємо
          зі священником та молитовною програмою.
        </p>
      </Container>
